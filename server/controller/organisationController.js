  ...
  MODEL.scheduleModel
    ...
    .then((jan) => {
      MODEL.scheduleModel
        ...
        .map((x) => x.quantity)
        .reduce((acc, curr) => acc + curr, 0);
      var januaryCarton = jan.filter((x) => x.Category == "carton" || x.Category == "Carton")
        .map((x) => x.quantity)
        .reduce((acc, curr) => acc + curr, 0);
      ...
      var januaryEwaste = jan
        .filter(
          (x) => x.Category == "eWaste" || x.Category == "e-waste"
        )
        .map((x) => x.quantity)
        .reduce((acc, curr) => acc + curr, 0);
        ...
        .map((x) => x.quantity)
        .reduce((acc, curr) => acc + curr, 0);
        var februaryPetBottle = feb
.filter((x) => x.Category == "petBottle" || x.Category == "petBottle")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var februaryCarton = feb.filter((x) => x.Category == "carton" || x.Category == "Carton")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
...
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var marchCarton = march.filter((x) => x.Category == "carton" || x.Category == "Carton")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
...
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var mayCarton = may.filter((x) => x.Category == "carton" || x.Category == "Carton")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var mayRubber = may
.filter((x) => x.Category == "Rubber" || x.Category == "rubber")
...
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var aprilCarton = april.filter((x) => x.Category == "carton" || x.Category == "Carton")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
...
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var juneCarton = june.filter((x) => x.Category == "carton" || x.Category == "Carton")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var juneRubber = june
.filter((x) => x.Category == "Rubber" || x.Category == "rubber")
...
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var julyCarton = july.filter((x) => x.Category == "carton" || x.Category == "Carton")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var julyRubber = july
.filter((x) => x.Category == "Rubber" || x.Category == "rubber")
...
var AugCan = Aug
        ...
        .map((x) => x.quantity)
        .reduce((acc, curr) => acc + curr, 0);
        var AugPetBottle = Aug
.filter((x) => x.Category == "petBottle" || x.Category == "petBottle")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var AugCarton = Aug.filter((x) => x.Category == "carton" || x.Category == "Carton")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var AugRubber = Aug
.filter((x) => x.Category == "Rubber" || x.Category == "rubber")
...
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var septCarton = sept.filter((x) => x.Category == "carton" || x.Category == "Carton")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var septRubber = sept
.filter((x) => x.Category == "Rubber" || x.Category == "rubber")
...
var OctCan = Oct
        ...
        .map((x) => x.quantity)
        .reduce((acc, curr) => acc + curr, 0);
        var OctPetBottle = Oct
.filter((x) => x.Category == "petBottle" || x.Category == "petBottle")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var OctCarton = Oct.filter((x) => x.Category == "carton" || x.Category == "Carton")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var OctRubber = Oct
.filter((x) => x.Category == "Rubber" || x.Category == "rubber")
...
var NovCan = Nov
        ...
        .map((x) => x.quantity)
        .reduce((acc, curr) => acc + curr, 0);
        var NovPetBottle = Nov
.filter((x) => x.Category == "petBottle" || x.Category == "petBottle")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var NovCarton = Nov.filter((x) => x.Category == "carton" || x.Category == "Carton")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var NovRubber = Nov
.filter((x) => x.Category == "Rubber" || x.Category == "rubber")
...
var DecCan = Dec
        ...
        .map((x) => x.quantity)
        .reduce((acc, curr) => acc + curr, 0);
        var DecPetBottle = Dec
.filter((x) => x.Category == "petBottle" || x.Category == "petBottle")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var DecCarton = Dec.filter((x) => x.Category == "carton" || x.Category == "Carton")
.map((x) => x.quantity)
.reduce((acc, curr) => acc + curr, 0);
var DecRubber = Dec
.filter((x) => x.Category == "Rubber" || x.Category == "rubber")
                                                      ...
                                                      RESPONSE.status(200).json(
                                                        {
                                                          JANUARY: {
                                                            ...
                                                            can: januaryCan,
                                                            petBottle: januaryPetBottle,
                                                            carton: januaryCarton,
                                                            rubber: januaryRubber,
                                                            plastics: januaryPlastics,
                                                            glass: januaryGlass,
                                                            metal: januaryMetal,
                                                            nylon: januaryNylon,
                                                    
                                                            eWaste : januaryEwaste
                                                          },
                                                          FEBRUARY: {
                                                            can: februaryCan,
                                                            petBottle: februaryPetBottle,
                                                            carton: februaryCarton,
                                                            rubber: februaryRubber,
                                                            plastics: februaryPlastics,
                                                            glass: februaryGlass,
                                                            metal: februaryMetal,
                                                            nylon: februaryNylon,
                                                    
                                                            eWaste : februaryEwaste

                                                          },
                                                          MARCH: {
                                                            can: marchCan,
                                                            petBottle: marchPetBottle,
                                                            carton: marchCarton,
                                                            rubber: marchRubber,
                                                            plastics: marchPlastics,
                                                            glass: marchGlass,
                                                            metal: marchMetal,
                                                            nylon: marchNylon,
                                                          ...
                                                          APRIL: {
                                                            can: aprilCan,
                                                            petBottle: aprilPetBottle,
                                                            carton: aprilCarton,
                                                            rubber: aprilRubber,
                                                            plastics: aprilPlastics,
                                                            glass: aprilGlass,
                                                            metal: aprilMetal,
                                                            nylon: aprilNylon,
                                                          ...
                                                          MAY: {
                                                            can: mayCan,
                                                            petBottle: mayPetBottle,
                                                            carton: mayCarton,
                                                            rubber: mayRubber,
                                                            plastics: mayPlastics,
                                                            glass: mayGlass,
                                                            metal: mayMetal,
                                                            nylon: mayNylon,
                                                          ...
                                                          JUNE:{
                                                            can: juneCan,
                                                            petBottle: junePetBottle,
                                                            carton: juneCarton,
                                                            rubber: juneRubber,
                                                            plastics: junePlastics,
                                                            glass: juneGlass,
                                                            metal: juneMetal,
                                                            nylon: juneNylon,
                                                          ...
                                                          JULY: {
                                                            ...
                                                            can: julyCan,
                                                            petBottle: julyPetBottle,
                                                            carton: julyCarton,
                                                            rubber: julyRubber,
                                                            plastics: julyPlastics,
                                                            glass: julyGlass,
                                                            metal: julyMetal,
                                                            nylon: julyNylon,
                                                          ...
                                                          AUGUST: {
                                                            can: AugCan,
                                                            petBottle: AugPetBottle,
                                                            carton: AugCarton,
                                                            rubber: AugRubber,
                                                            plastics: AugPlastics,
                                                            glass: AugGlass,
                                                            metal: AugMetal,
                                                            nylon: AugNylon,
                                                          ...
                                                          SEPTEMBER: {
                                                            can: septCan,
                                                            petBottle: septPetBottle,
                                                            carton: septCarton,
                                                            rubber: septRubber,
                                                            plastics: septPlastics,
                                                            glass: septGlass,
                                                            metal: septMetal,
                                                            nylon: septNylon,
                                                          ...
                                                          OCTOBER: {
                                                            can: OctCan,
                                                            petBottle: OctPetBottle,
                                                            carton: OctCarton,
                                                            rubber: OctRubber,
                                                            plastics: OctPlastics,
                                                            glass: OctGlass,
                                                            metal: OctMetal,
                                                            nylon: OctNylon,
                                                          ...
                                                          NOVEMBER: {
                                                            can: NovCan,
                                                            petBottle: NovPetBottle,
                                                            carton: NovCarton,
                                                            rubber: NovRubber,
                                                            plastics: NovPlastics,
                                                            glass: NovGlass,
                                                            metal: NovMetal,
                                                            nylon: NovNylon,
                                                          ...
                                                          DECEMBER: {
                                                            can: DecCan,
                                                            petBottle: DecPetBottle,
                                                            carton: DecCarton,
                                                            rubber: DecRubber,
                                                            plastics: DecPlastics,
                                                            glass: DecGlass,
                                                            metal: DecMetal,
                                                            nylon: DecNylon,
