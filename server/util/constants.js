...
let SERVER = {
  ...
  ISACTIVE: [{ NOT_VERIFIED: 0 }, { VERIFIED: 1 }, { DELETED: 2 }],
};
...
let STATUS_MSG = {
  ERROR: {
    ...
    CAN_NOT_DELETE: {
      ...
      type: "CAN_NOT_DELETE",
      customMessage:
        "Plz reallocate all lead to another Sales Executive first!",
    },
    PENDING_CONFIRM: {
      statusCode: 400,
...
const PROCESS_STATUSES_ENUM = Object.freeze([
  "PENDING",
  "APPROVED",
  "REJECTED",
]);
